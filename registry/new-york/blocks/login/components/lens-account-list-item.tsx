...
export function LensAccountListItem({
  ...
  return (
    <button
      ...
      className={`w-full flex items-center text-start mb-0.5 p-2 gap-2 enabled:cursor-pointer enabled:hover:bg-neutral-100 enabled:focus:bg-neutral-100 focus:outline-0 rounded-sm ${isSelected ? "border" : "disabled:opacity-45"}`}
    >
