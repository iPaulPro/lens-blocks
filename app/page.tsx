    ...
    <div className="w-full h-full relative">
      <div className="max-w-3xl flex flex-col min-h-svh px-12 py-8 gap-8">
        <header className="flex flex-col gap-1">
          <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight text-balance">Lens Blocks</h1>
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="content">
            ...
            (Markdown, mentions, reactions), a follow button, and a WYSIWYG composer/editor. Each block deeply
            integrates the Lens React SDK and handles wallet connection, signing, authentication, session lifecycle,
            optimistic updates, and state management out of the box.
          </p>
          {/*<Image*/}
      ...
      <QueryClientProvider client={queryClient}>
        <ConnectKitProvider>{children}</ConnectKitProvider>
          ...
          <CodeBlock
            lang="tsx"
            className="lines"
          >{`<LensProvider client={client}>{children}</LensProvider>`}</CodeBlock>
